...
Open up the bug tracker for `ubuntu-touch <https://gitlab.com/ubports/development/ubuntu-touch>`_.
...
First, pull up the `bug tracker <https://gitlab.com/ubports/development/ubuntu-touch>`_ and click "New Issue". Log in to GitHub if you haven't yet.
