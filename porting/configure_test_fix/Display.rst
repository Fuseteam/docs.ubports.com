...
Once you have adjusted the ``android.conf`` file to the display settings needed for your device, this file should be incorporated into your build. See :doc:`the overlay documentation </porting/configure_test_fix/Overlay>`.
